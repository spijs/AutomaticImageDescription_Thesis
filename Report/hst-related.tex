...
Entropie-gebaseerde modellen willen de meest uniforme kansverdeling vormen over de opeenvolging van woorden. Deze kansverdeling moet voldoen aan een aantal beperkingen. Deze beperkingen kunnen bestaan uit het al dan niet mogelijk zijn van een bepaalde opeenvolging, een aantal sjablonen,\ldots Op deze manier maakt het model enkel gebruik van wat het zeker weet en negeert het elke onwaarschijnlijkheid. \todo{citen + duidelijker maken}
