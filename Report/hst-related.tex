...
\subsection{Voorstellen van zinnen}
 ...
 \begin{figure}[tb]
     ...
     \caption[Zin met ontlede afhankelijkheidstriplets]{Zin met ontlede afhankelijkheidstriplets~\cite{Karpathy2014}. Het eerste element is de code van het relatietype tussen de twee volgende elementen.}
