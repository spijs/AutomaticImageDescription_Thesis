...
\begin{subfigure}{\textwidth}
    ...
    \centering
    \vspace{0pt}
    \includegraphics[height=3.5cm]{Images/LDA/4691655601.jpg}
    \end{minipage}\hfill
    \begin{minipage}[t]{.5\textwidth}
    \centering
    \vspace{0pt}
...
\begin{subfigure}{\textwidth}
    ...
    \centering
    \vspace{0pt}
    \includegraphics[height=3.5cm]{Images/LDA/2773744784.jpg}
    \end{minipage}\hfill
    \begin{minipage}[t]{.5\textwidth}
    \centering
    \vspace{0pt}
    ...
    \end{minipage}
\end{subfigure}
\caption{Afbeeldingen met de vijf beste onderwerpen, correcte voorspelling}
\end{figure}
...
\begin{subfigure}{\textwidth}
    ...
    \centering
    \vspace{0pt}
    \includegraphics[height=3.5cm]{Images/LDA/136693281.jpg}
    \end{minipage}\hfill
    \begin{minipage}[t]{.5\textwidth}
    \centering
    \vspace{0pt}
    ...
    \end{minipage}
\end{subfigure}
\caption{Afbeeldingen met de vijf beste onderwerpen, ongeveer correcte voorspelling}
\end{figure}
\clearpage
...
\begin{subfigure}{\textwidth}
	...
	\begin{minipage}[t][3.5cm]{.5\linewidth}
		\centering
		\vspace{0pt}
		\includegraphics[height=3.5cm]{Images/LDA/3294830188.jpg}
	\end{minipage}\hfill
	\begin{minipage}[t]{.5\textwidth}
		\centering
		\vspace{0pt}
	...
	\end{minipage}
\end{subfigure}
\caption{Afbeeldingen met de vijf beste onderwerpen, incorrecte voorspelling}
\end{figure}