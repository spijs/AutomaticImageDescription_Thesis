...
\setup{filingcard,
  ...
  De derde uitbreiding op het initieel systeem is een normalisatiefunctie die tijdens het genereren van zinnen voor langere en hoger scorende beschrijvingen zorgt. Ons best presterende model gebruikt een LSTM-netwerk als taalmodel, lengtenormalisatie en onderwerpverdelingen als semantische gids. Dit model presteert gelijkaardig aan de literatuur.}}
