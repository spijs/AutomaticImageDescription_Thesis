...
\setup{filingcard,
  ...
  Experimenten naar de ruisgevoeligheid van beide informatiebronnen bieden het nieuwe inzicht dat beide bronnen van informatie redelijk robuust zijn tegen licht gewijzigde data.
