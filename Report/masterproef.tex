...
\setup{filingcard,
  ...
  Experimenten naar de ruisgevoeligheid van beide informatiebronnen tonen aan dat de projectie in de multimodale ruimte beter geschikt is voor het leren van afbeeldingsbeschrijvingen waarbij de trainingsverzameling ruis vertoont in de correcte beschrijvingen.
  De tweede uitbreiding op het initieel systeem is een normalisatiefunctie die tijdens het genereren van zinnen voor langere en meer kwalitatieve beschrijvingen zorgt. Het definieert hiervoor een functie die als doel heeft de zinslengteverdeling van de trainingsverzameling na te bootsen.
  De derde uitbreiding is een normalisatiefunctie die focust op minder gebruikte woorden in de trainingsverzameling met als doel creatievere en minder vage zinnen te genereren. Experimenten wijzen uit dat deze methode zorgt voor een grotere woordenschat en meer unieke en menselijkere beschrijvingen. Helaas is deze tweede normalisatie niet altijd in staat om de afbeelding op een grammaticaal en inhoudelijk correcte staat te beschrijven.
  In vergelijking met de meest recente literatuur scoren de modellen uit deze masterproef zeker niet ondermaats.
  Systemen die gebruik maken van aandachtsmodellen presteren wel steeds beter, maar dit gaat ten koste van meer complexiteit.}}
...
\begin{abstract}
 ...
 Deze masterproef biedt een aantal oplossingen voor deze problemen. Dit werk vertrekt vanaf een bestaande implementatie van twee systemen. Deze systemen gebruiken een eerste neuraal netwerk om afbeeldingen om te zetten in vectorvoorstellingen. Vervolgens dient deze voorstelling als invoer in een tweede neuraal netwerk dat als taalmodel dient. Uit dit taalmodel bepaalt een algoritme dan de meest waarschijnlijke beschrijving. Deze systemen trainen en testen met vooraf verzamelde verzamelingen van afbeeldingen en bijbehorende beschrijvingen.
