...
Het trainen van het RNN gebeurt op basis van de Flickr30k dataset. Er worden random afbeeldingen met 1 van de 5 bijhorende beschrijvingen aan het netwerk gegeven. De eerder vermeldde terugpropagatie zorgt voor de juiste aanpassing aan de gewichten. Wanneer de trainingsset volledig is doorlopen vindt een evaluatie plaats. Op basis van de BLEU-4 score (zie verder) berekend op de gegenereerde zinnen voor de validatieset bepalen we dan of er verbetering is sinds de vorige iteratie, en of de training al dan niet dient te stoppen. Eerder in het proces maakten we gebruik van de perplexity berekend op de validatie set, maar het blijkt dat een lagere validatieperplexity niet automatisch leidt tot een beter scorend systeem.
