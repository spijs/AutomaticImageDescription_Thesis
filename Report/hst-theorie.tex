...
In deze thesis komt een softmax voor als laatste laag bij de gebruikte CNN \mbox{(sectie \ref{sec:usedcnn})}, als laatste laag in het netwerk bij de voorspelling van LDA-topicverde\-lingen (sectie \ref{sec:LDAprediction}) en als laatste laag in de gebruikte taalnetwerken (sectie \ref{sec:rnn_methodology} en \ref{sec:lstm}).
