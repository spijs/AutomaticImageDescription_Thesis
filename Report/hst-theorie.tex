...
Op deze manier is de fout op de output \myvector{\hat{y}-y} verkleind, deels door de verandering in \myvector{W} en deels door die in \myvector{W'}. Deze methode kan eenvoudig worden uitgebreid naar een netwerk met een arbitrair aantal verborgen lagen.
