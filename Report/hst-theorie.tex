...
\end{equation}
\todo[inline]{eerst algemene formule en dan logistische als voorbeeld?}
\todo[inline]{sigma (= learning rate?) niet besproken}
...
\todo[inline]{Misschien ergens kort gradient descent ofwel uitleggen ofwel referencen?}
\begin{equation}
