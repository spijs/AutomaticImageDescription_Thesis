...
Verder onderzoek naar variaties op deze normalisatie lijkt nuttig. Wanneer de fouten zouden verdwijnen, lijken de zinnen immers meer menselijk.
...
Zo is verder onderzoek nodig naar de integratie van dit en soortgelijke systemen in browsers en applicaties voor blinden en slechtzienden. Net zoals Facebook~\cite{facebook} al gebruikt op hun website, kan een algemene browser die elke afbeelding automatisch omzet in een beschrijving en deze bijvoorbeeld voorleest, zeker op appreciatie rekenen.
