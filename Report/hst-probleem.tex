...
Dit werk gebruikt Flickr30k als dataset voor de training en evaluatie. Hoewel \mbox{MS Coco} groter is en meer complexere afbeeldingen bevat, maakt de grootte van Flickr30k snellere training van het systeem mogelijk. Daarnaast is deze dataset ook de in de literatuur de meest gebruikte wat de vergelijking tussen bestaande systemen mogelijk maakt. 
