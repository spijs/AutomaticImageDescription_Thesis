...
In onze experimenten stellen we de Brevity Penalty steeds gelijk aan 1. Het gebruik van lengtenormalisatie bij beam search leidt ook tot een Brevity Penalty van 1, waardoor het niet nodig is om deze factor nog expliciet toe te voegen.
